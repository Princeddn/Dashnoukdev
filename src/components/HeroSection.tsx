...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-apple-blue/5 via-apple-purple/5 to-apple-orange/5">
      {/* Gradient background */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-apple-blue/20 via-transparent to-transparent" />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
          ...
          <div className="flex justify-center lg:justify-end animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            <div className="relative">
              {/* Cercles décoratifs */}
              <div className="absolute -inset-4 bg-gradient-to-r from-apple-blue to-apple-purple rounded-full opacity-20 blur-2xl" />
              <div className="absolute -inset-2 bg-gradient-to-r from-apple-purple to-apple-orange rounded-full opacity-10 blur-xl" />
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-bounce">
        <div className="w-6 h-10 border-2 border-apple-gray-300 rounded-full flex items-start justify-center p-2">
          <div className="w-1.5 h-2 bg-apple-blue rounded-full" />
        </div>
      </div>
    </section>
  );
